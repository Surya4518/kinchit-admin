...
<head>
    ...
    <title> KINCHITKARAM :: User Create </title>
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"> Create User
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3 id="page_title_name">Create User </h3>
                        <div class="card-body">
                            <div class="volun-frm">
                                <form method="post" enctype="multipart/form-data" id="user_profile_create_form">
                                   <div class="row mb-2">
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Enter Your First Name: <span style="color:#f90404">*</span></label>
                                           <input type="name" class="form-control" id="user_first_name" name="user_first_name" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <input type="name" class="form-control" id="user_last_name" name="user_last_name" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Mobile / SMS: <span style="color:#f90404">*</span></label>
                                            <input type="name" class="form-control" id="user_sms_no" name="user_sms_no" aria-describedby="emailHelp" pattern="[0-9]{1,10}" maxlength="10">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="text" class="form-control" id="user_wa_no" name="user_wa_no" aria-describedby="emailHelp" pattern="\d*" maxlength="10">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="date_birth" name="date_birth" aria-describedby="emailHelp" max="<?php echo date('Y-m-d'); ?>">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="samasar" name="samasar" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="address1" name="address1" aria-describedby="emailHelp">
                                        ...
                                        <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="address2" name="address2" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="country_name" name="country_name" value="India" readonly aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <!--<input type="name" class="form-control" id="state_name" name="state_name" aria-describedby="emailHelp">-->
                                           <select class="form-control" id="state_name" name="state_name"></select>
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <!--<input type="name" class="form-control" id="city_name" name="city_name" aria-describedby="emailHelp">-->
                                        <select class="form-control" id="city_name" name="city_name"></select>
                                        <p class="validate_errors" id="city_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                         ...
                                         <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="pincode" name="pincode" aria-describedby="emailHelp">
                                           <p class="validate_errors" id="pincode_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                        <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Educational Qualification: <span style="color:#f90404">*</span></label>
                                           <input type="name" class="form-control" id="qualification" name="qualification" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="workexp" name="workexp" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="special_interest" name="special_interest" aria-describedby="emailHelp">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="name" class="form-control" id="special_skill" name="special_skill" aria-describedby="emailHelp">
                                           <p class="validate_errors" id="special_skill_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="col-md-6 mb-3">
                                        <label for="name" class="form-label">User Type <span style="color:#f90404">*</span></label>
                                        <select class="form-control" id="user_type" name="user_type">
                                            <option value="">Select Type</option>
                                            <option value="general-user">General User</option>
                                            <option value="volunteer">Volunteer</option>
                                            <option value="member">Member</option>
                                            <option value="kalakshepam">Kalakshepam</option>
                                        </select>
                                        <p class="validate_errors" id="user_type_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-md-6 mb-3 d-none volunteer_list">
                                        <label for="name" class="form-label">Volunteer <span style="color:#f90404">*</span></label>
                                        <select class="form-control select2" id="volunteer_id" name="volunteer_id">
                                            <option value="">Select Volunteer</option>
                                            @for ($i=0; $i < $volunteer->count(); $i++)
                                                <option value="{{ $volunteer[$i]->user_login }}">{{ $volunteer[$i]->user_login }}</option>
                                                @endfor
                                        </select>
                                        <p class="validate_errors" id="volunteer_id_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                         <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Upload Profile Photo: <span style="color:#f90404">*</span></label>
                                           <input type="file" accept=".jpg,.jpeg,.png,.webp" class="form-control" id="user_photo" name="user_photo">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="user_username" name="user_username" maxlength="60" minlength="10">
                                        <p class="validate_errors" id="user_username_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="name" class="form-label">Password: <span style="color:#f90404">*</span></label>
                                        <input type="password" class="form-control" id="user_password" name="user_password"maxlength="16" minlength="8">
                                        <span class="eye" id="eye_user_password" onclick="ShowPass('user_password')" style="float: right;margin: -25px 12px -8px 0;"><i class="fa fa-eye"></i></span>
                                        <p class="validate_errors" id="user_password_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                   </div>
                                   <div class="row justify-content-center">
                                       <div class="col-md-12 text-center">
                                          <button type="button" id="user-profile-create" class="btn btn-secondary">Submit</button>
                                       </div>
                                   </div>
                                </form>
                            </div>
