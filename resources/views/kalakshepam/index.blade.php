...
<head>
    ...
    <title> KINCHITKARAM :: Kalakshepam </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Kalakshepam Users</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Kalakshepam Users
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="kalakshepam-table" class="table">
    ...
    @include('kalakshepam.partials.kalakshepamjs')
