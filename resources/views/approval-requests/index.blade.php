...
<head>
    ...
    <title> KINCHITKARAM :: Requests </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Approval Requests</a></li>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="row">
                            <form method="POST" id="students_filter_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-2 mt-2">
                                            <label for="name">Request Type:</label>
                                            <select class="form-control select2" name="request_filter" id="request_filter">
                                                <option value="">---Select Request Type---</option>
                                                @for ($i=0; $i < $request->count(); $i++)
                                                <option value="{{ $request[$i]->id }}">{{ $request[$i]->request_type }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                    <div class ="row justify-content-center">
                                        <div class="col-md-3">
                                            {{-- <button type="button" onclick="ShowStudentsList()" class="btn btn-secondary">Search<span id="students_filter"></span></button> --}}
                                        </div>
                                    </div>
        ...
        @include('approval-requests.partials.request_approve_modal_volunteer')
        @include('approval-requests.partials.request_approve_modal_member')
        @include('approval-requests.partials.request_approve_modal_donor')
        @include('approval-requests.partials.request_reject_modal')
        @include('approval-requests.partials.request_approve_modal_volunteer_member')
    </div>
    ...
    @include('approval-requests.partials.approval-requestsjs')
