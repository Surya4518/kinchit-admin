        ...
        <div class="card-body">
            <div class="volun-frm">
                <form method="" enctype="multipart/form-data" id="user_profile_update">
                    <div class="row mb-2">
                        <div class="col-md-6 mb-3">
                            <label for="user_first_name" class="form-label">Enter Your First Name: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" value="{{ $user[0]->first_name }}" id="user_first_name" name="user_first_name" aria-describedby="emailHelp" pattern="[A-Za-z. ]+" title="Please enter only alphabetical characters, spaces, and periods (dots)">
                            <p class="validate_errors" id="user_first_name_error" style="color: #f90404; font-size: 13px; font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_last_name" class="form-label">Enter Your Last Name: <span style="color:#f90404">*</span></label>
                            <input type="name" class="form-control" value="{{ $user[0]->last_name }}" id="user_last_name" name="user_last_name" aria-describedby="emailHelp" pattern="[A-Z]" title="Please enter only alphabetical characters">
                            <p class="validate_errors" id="user_last_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_email" class="form-label">Email Address: <span style="color:#f90404">*</span></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="date_birth" class="form-label">Date of Birth: <span style="color:#f90404">*</span></label>
                            <input type="date" class="form-control" value="{{ $user[0]->dob }}" id="date_birth" name="date_birth" aria-describedby="emailHelp" max="<?php echo date('Y-m-d'); ?>">
                            <p class="validate_errors" id="date_birth_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_photo" class="form-label">Upload Profile Photo: <span style="color:#f90404">*</span></label>
                        ...
                        <div class="col-md-6 mb-5">
                            <label for="user_username" class="form-label">Username: <span style="color:#f90404">*</span></label>
