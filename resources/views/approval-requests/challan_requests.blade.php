                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Bank Challan Requests</a></li>
                                ...
                                <table id="request-table" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i=0; $i < count($requests); $i++)
                                            <tr>
                                                <td>{{ $i+1 }}</td>
                                                <td>{{ $requests[$i]->volunteer_code }}</td>
                                                <td>{{ $requests[$i]->volunteer_email }}</td>
                                                <td>{{ $requests[$i]->display_name }}</td>
                                                <td>{{ $requests[$i]->challan_in_hand}}</td>
                                            </tr>
                                        @endfor
