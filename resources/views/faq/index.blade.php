...
<head>
    ...
    <title> KINCHITKARAM :: Faq's </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Faq's
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_faq_modal">Create Faq<i
        ...
        @include('faq.partials.faq_create_modal')
        @include('faq.partials.edit_faq_modal')
    </div>
