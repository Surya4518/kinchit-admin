...
<head>
    ...
    <title> KINCHITKARAM :: Donation Category </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Donation Category</a></li>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary donationcategorycreatemodal">Create<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="donation-category-table" class="table">
        ...
        @include('donation-category.partials.donation_create_modal')
        @include('donation-category.partials.donation_edit_modal')
    </div>
    ...
    @include('donation-category.partials.donation_categoryjs')
