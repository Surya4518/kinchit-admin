    ...
    <div class="modal-dialog" role="document" style="width: 75%;">
      <div class="modal-content">
        ...
        <div class="modal-footer mx-auto">
            <button class="btn btn-secondary" onclick="CreateDonationCategory()">Submit</button>
        </div>
      </div>
    </div> <!-- modal-bialog .// -->
  </div> <!-- modal.// -->
