...
<head>
    ...
    <title> KINCHITKARAM :: Courses </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Edit Course
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_course_frm" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="course_title">Title</label>
                                        <input type="text" class="form-control" name="course_title" id="course_title" value="{{ $courses[0]->post_title }}" placeholder="Enter Course Name">
                                        <p class="validate_errors" id="course_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="course_post_status">Publish Status</label>
                                        <select class="form-control" name="course_post_status" id="course_post_status">
                                            <option value="">Select Status</option>
                                            <option {{ $courses[0]->post_status == 'publish' ? 'selected' : '' }} value="publish">Public</option>
                                            <option {{ $courses[0]->post_status == 'private' ? 'selected' : '' }} value="private">Private</option>
                                        </select>
                                        <p class="validate_errors"  id="course_post_status_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="course_publish_date">Schedule Publish Date</label>
                                        <input type="datetime-local" class="form-control" name="course_publish_date" id="course_publish_date"  value="{{ date("Y-m-d H:i:s",strtotime($courses[0]->post_date_gmt)) }}">
                                        <p class="validate_errors"  id="course_publish_date_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="course_publish_date">Upanyasam</label>
                                        <input type="text" class="form-control" name="upanyasam_name" id="upanyasam_name" value="{{ $courses[0]->upanyasam_name }}">
                                        <p class="validate_errors"  id="upanyasam_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="course_publish_date">Tutor Name</label>
                                        <input type="text" class="form-control" name="tutor_name" id="tutor_name" value="{{ $courses[0]->tutor_name }}">
                                        <p class="validate_errors"  id="tutor_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="course_image">Image</label>
                                        <input type="file" class="form-control" name="course_image" accept=".jpg,.jpeg,.png,.webp"  id="course_image">
                                        @if ($courses[0]->guid != NULL)
                                        <img src="{{ asset($courses[0]->guid) }}" alt="" style="width: 19%;">
                                        <span><a href="javascript:DeleteTheImage({{ $courses[0]->ID }})" title="Edit Item" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary editservices"><i class="fe fe-x" style="font-size:16px;"></i></a></span>
                                        @endif
                                        <p class="validate_errors"  id="course_image_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="course_image">Local Entry Form Download</label>
                                        <input type="file" class="form-control" name="course_local_form" accept=".pdf" id="course_local_form">
                                        @if ($courses[0]->down_frm_pdf != NULL)
                                        <a target="_blank" href="{{ asset($courses[0]->down_frm_pdf) }}">Preview</a>
                                        <span><a href="javascript:DeleteThePdf({{ $courses[0]->ID }})" title="Edit Item" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary editservices"><i class="fe fe-x" style="font-size:16px;"></i></a></span>
                                        @endif
                                        <p class="validate_errors"  id="course_local_form_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <label for="course_content">Content</label>
                                        <textarea class="summernote" name="course_content" id="course_content" cols="30" rows="10">{{ $courses[0]->post_content }}</textarea>
                                        <p class="validate_errors"  id="course_content_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="course_edit_id" id="course_edit_id" value="{{ $courses[0]->ID }}">
                                        <button type="button" class="btn btn-secondary" id="update-course">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('namaste-lms.course.partials.coursejs')
