            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Course
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_course_frm" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="course_title">Title</label>
                                        <input type="text" class="form-control" name="course_title" id="course_title" placeholder="Enter Course Name">
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="course_publish_date" id="course_publish_date"  value="{{ date("Y-m-d H:i:s") }}">
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <input type="text" class="form-control" name="upanyasam_name" id="upanyasam_name" >
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <textarea class="summernote" name="course_content" id="course_content" cols="30" rows="10"></textarea>
                                    ...
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-course">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
