...
<head>
    ...
    <title> KINCHITKARAM :: Students </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Students
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="button text-end mb-4">
                            <a type="button" href="/create-user-profile" class="btn btn-secondary tut_categorycreatemodal">Add Student<i class="fa fa-plus mx-2"></i></a>
                        </div>
                        <div class="button text-end mb-4">
                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#assign_student_for_course_modal">Assign Course<i
        ...
        @include('namaste-lms.students.partials.assign_student_for_course_modal');
    </div>
    ...
    <script></script>
    @include('namaste-lms.students.partials.studentsjs');
