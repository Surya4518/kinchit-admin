            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Lesson
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_lesson_frm">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="lesson_title">Title</label>
                                        <input type="text" class="form-control" name="lesson_title" id="lesson_title" placeholder="Enter Lesson Title">
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="lesson_publish_date" id="lesson_publish_date"  value="{{ date("Y-m-d H:i:s") }}">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <textarea class="summernote" name="lesson_content" id="lesson_content" cols="30" rows="10"></textarea>
                                    ...
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-lesson">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
