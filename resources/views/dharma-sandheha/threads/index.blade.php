                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Threads
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="/create-thread">Create Thread<i class="fa fa-plus mx-2"></i></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="thread-table" class="table">
