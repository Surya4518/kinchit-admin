...
<head>
    ...
    <title> KINCHITKARAM :: Threads </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Threads</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit Thread
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_thread_frm">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="thread_title">Thread Title</label>
                                        <input type="text" class="form-control" name="thread_title" id="thread_title" value="{{ $thread[0]->post_title }}" placeholder="Enter Course Name">
                                        <p class="validate_errors" id="thread_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="thread_post_status">Publish Status</label>
                                        <select class="form-control" name="thread_post_status" id="thread_post_status">
                                            <option value="">Select Status</option>
                                            <option {{ $thread[0]->post_status == 'publish' ? 'selected' : '' }} value="publish">Public</option>
                                            <option {{ $thread[0]->post_status == 'pending' ? 'selected' : '' }} value="pending">Pending</option>
                                        </select>
                                        <p class="validate_errors"  id="thread_post_status_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <label for="thread_content">Thread</label>
                                        <textarea class="summernote" name="thread_content" id="thread_content" cols="30" rows="10">{{ $thread[0]->post_content }}</textarea>
                                        <p class="validate_errors"  id="thread_content_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="edit_thread_id" id="edit_thread_id" value="{{ $thread[0]->ID }}">
                                        <button type="button" class="btn btn-secondary" id="update-thread">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('dharma-sandheha.threads.partials.threadjs')
