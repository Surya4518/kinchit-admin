            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Thread
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_thread_frm">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="thread_title">Thread Title</label>
                                        <input type="text" class="form-control" name="thread_title" id="thread_title" placeholder="Enter Thread Title">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <textarea class="summernote" name="thread_content" id="thread_content" cols="30" rows="10"></textarea>
                                    ...
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-thread">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
