            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Reply
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_reply_frm">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="reply_parent_thread_id" id="reply_parent_thread_id">
                                            ...
                                            <option value="{{ $threads[$i]->ID }}">{{ $threads[$i]->post_title }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="reply_title" id="reply_title" placeholder="Enter Reply Title">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        ...
                                        <textarea class="summernote" name="reply_content" id="reply_content" cols="30" rows="10"></textarea>
                                    ...
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-reply">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
