                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Replies
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="/create-reply">Create Reply<i class="fa fa-plus mx-2"></i></a>
                        </div>
                        <div class="row">
                            <form method="POST" id="replies_filter_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-2 mt-2">
                                            <label for="name">Threads:</label>
                                            <select class="form-select" name="replies_filter" id="replies_filter">
                                    ...
                                    <div class ="row justify-content-center mt-4">
                                        <div class="col-md-3">
                                            <button type="button" onclick="showRepliesList()" class="btn btn-secondary">Search Replies<span id="replies_filter"></span></button>
                                        </div>
                                    </div>
