...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                        ...
                        <div class="main-header-right">
                            ...
                            <div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
                                <div class="nav-item full-screen fullscreen-button">
                                    <a class="new nav-link full-screen-link" href="javascript:void(0);"><i class="fe fe-bell"></i></span></a>
        ...
        <div class="sticky">
            <aside class="app-sidebar sidebar-scroll">
                <div class="main-sidebar-header active">
                    <a class="desktop-logo logo-light active" href=""><img src="{{ asset('theme/assets/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Pending Requests</a></li>
        ...
        @include('delivery-request.partials.request_approve_modal_volunteer')
        @include('delivery-request.partials.request_approve_modal_member')
        @include('delivery-request.partials.request_approve_modal_donor')
        @include('delivery-request.partials.request_reject_modal')
    </div>
    ...
    @include('delivery-request.partials.approval-requestsjs')
