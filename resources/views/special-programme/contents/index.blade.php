...
<head>
    ...
    <title> KINCHITKARAM :: Special Programme </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Special Programme</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Special Programme contens
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Special Programme Contents</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary spec_contentcreatemodal">Add Content<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="specontent-table" class="table">
        ...
        @include('special-programme.contents.partials.content_create_modal')
        @include('special-programme.contents.partials.content_edit_modal')
    </div>
    ...
    @include('special-programme.contents.partials.spec_pro_contetntjs')
