...
<head>
    ...
    <title> KINCHITKARAM :: Donation </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary donationcreatemodal">Create<i
        ...
        @include('general-donation.partials.donation_create_modal')
        @include('general-donation.partials.donation_edit_modal')
    </div>
    ...
    @include('general-donation.partials.general-donationjs')
