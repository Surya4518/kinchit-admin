...
<head>
    ...
    <title> KINCHITKARAM :: Change Password </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form name="sitesettings" id="sitesettings" method="post" class="form-horizontal" novalidate="novalidate">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="oldpass">Old Password <span class="text-red">*</span></label>
                                            <input type="password" class="form-control" placeholder="Enter Old Password" name="oldpass" id="oldpass" maxlength="20">
                                            <span class="eye" id="eye_oldpass" onclick="ShowPass('oldpass')" style="float: right;margin: -25px 12px -8px 0;"><i class="fa fa-eye"></i></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="newpass">New Password <span class="text-red">*</span></label>
                                            <input type="password" class="form-control" placeholder="Enter New Password" name="newpass" id="newpass" maxlength="20">
                                            <span class="eye" id="eye_newpass" onclick="ShowPass('newpass')" style="float: right;margin: -25px 12px -8px 0;"><i class="fa fa-eye"></i></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="connewpass">Confirm New Password <span class="text-red">*</span></label>
                                            <input type="password" class="form-control" placeholder="Enter Confirm New Password" name="connewpass" maxlength="20" id="connewpass">
                                            <span class="eye" id="eye_connewpass" onclick="ShowPass('connewpass')" style="float: right;margin: -25px 12px -8px 0;"><i class="fa fa-eye"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-footer text-center">
                                    <button type="button" onclick="ChangeAdminPassword()" class="btn btn-primary">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div><!-- //row -->
    ...
    @include('settings.change-password.partials.passwordjs')
