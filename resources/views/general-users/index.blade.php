...
<head>
    ...
    <title> KINCHITKARAM :: General Users </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show General Users
                                </li>
                            </ol>
                        </nav>
                    </div>
    ...
    @include('general-users.partials.general-usersjs')
