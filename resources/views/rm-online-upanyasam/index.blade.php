...
<head>
    ...
    <title> KINCHITKARAM :: RM ONLINE UPANYASAM </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">RM Online Upanyasam</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show RM Online Upanyasam Albums
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>RM Online Upanyasam Albums</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary tut_categorycreatemodal">Create Category<i
        ...
        @include('rm-online-upanyasam.partials.category_create_modal')
        @include('rm-online-upanyasam.partials.category_edit_modal')
    </div>
    ...
    @include('rm-online-upanyasam.partials.categoryjs')
