    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create RM Online Upanyasam Audio
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Create RM Online Upanyasam Audio</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_rmonline_audio_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="rmonline_audio_title">Title</label>
                                        <input type="text" class="form-control" name="rmonline_audio_title" id="rmonline_audio_title" placeholder="Enter Audio Name">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="rmonline_audio_category" id="rmonline_audio_category">
                                            ...
                                            <option value="{{ $rmonline_categories[$i]->id }}">{{ $rmonline_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control summernote" name="rmonline_audio_file" id="rmonline_audio_file" cols="30" rows="10"></textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control summernote" name="rmonline_audio_download_links" id="rmonline_audio_download_links" cols="30" rows="10"></textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-rmonline-audio">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
