...
<head>
    ...
    <title> KINCHITKARAM :: RM Online Upanyasam Audios </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">RM Online Upanyasam Audio</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit RM Online Upanyasam Audio
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Edit RM Online Upanyasam Audio</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_rmonline_audio_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="rmonline_audio_title">Title</label>
                                        <input type="text" class="form-control" name="rmonline_audio_title" id="rmonline_audio_title" value="{{ $audio[0]->post_title }}" placeholder="Enter Audio Name">
                                        <p class="validate_errors" id="rmonline_audio_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="rmonline_audio_category">Category</label>
                                        <select class="form-control" name="rmonline_audio_category" id="rmonline_audio_category">
                                            <option value="">Select category</option>
                                            @for ($i=0; $i < $rmonline_categories->count(); $i++)
                                            <option {{ $audio[0]->category_id == $rmonline_categories[$i]->id ? 'selected' : '' }} value="{{ $rmonline_categories[$i]->id }}">{{ $rmonline_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors"  id="rmonline_audio_category_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12">
                                        <label for="rmonline_audio_file">Enter Content</label>
                                        <textarea class="form-control summernote" name="rmonline_audio_file" id="rmonline_audio_file" cols="30" rows="10">{{ $audio[0]->post_content }}</textarea>
                                        <p class="validate_errors" id="rmonline_audio_file_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12">
                                        <label for="rmonline_audio_file">Download Links</label>
                                        <textarea class="form-control summernote" name="rmonline_audio_download_links" id="rmonline_audio_download_links" cols="30" rows="10">{{ $audio[0]->download_url }}</textarea>
                                        <p class="validate_errors" id="rmonline_audio_download_links_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="rmonline_audio_id" id="rmonline_audio_id" value="{{ $audio[0]->id }}">
                                        <button type="button" class="btn btn-secondary" id="update-rmonline-audio">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('rm-online-upanyasam.audio.partials.audiojs')
