    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create RM Online Upanyasam Video
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Create RM Online Upanyasam Video</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_rmonline_video_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="rmonline_video_title">Title</label>
                                        <input type="text" class="form-control" name="rmonline_video_title" id="rmonline_video_title" placeholder="Enter video Name">
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <textarea class="form-control summernote" name="rmonline_video_content" id="rmonline_video_content" cols="30" rows="10"></textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-rmonline-video">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
