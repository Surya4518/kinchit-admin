...
<head>
    ...
    <style>
        ...
        #player-container .play-pause {
            ...
            padding: 0px 0px;
            z-index: 2;
            background-image: url(../../theme/assets/img/play.svg);
        ...
        .pause {
            background-image: url(../../theme/assets/img/paues.svg) !important;
        }
    </style>
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show RM Online Upanyasam Videos
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>RM Online Upanyasam Videos</h3>
                        <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="{{ route('create-rmonline-video.rm_video') }}">Create Video<i
