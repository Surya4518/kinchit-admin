...
<head>
    ...
    <title> KINCHITKARAM :: RM Online Upanyasam Videos </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">RM Online Upanyasam Video</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit RM Online Upanyasam Video
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Edit RM Online Upanyasam Video</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_rmonline_video_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="rmonline_video_title">Title</label>
                                        <input type="text" class="form-control" name="rmonline_video_title" id="rmonline_video_title" value="{{ $video[0]->post_title }}" placeholder="Enter video Name">
                                        <p class="validate_errors" id="rmonline_video_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="rmonline_video_category">Category</label>
                                        <select class="form-control" name="rmonline_video_category" id="rmonline_video_category">
                                            <option value="">Select category</option>
                                            @for ($i=0; $i < $rmonline_categories->count(); $i++)
                                            <option {{ $video[0]->category_id == $rmonline_categories[$i]->id ? 'selected' : '' }} value="{{ $rmonline_categories[$i]->id }}">{{ $rmonline_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors"  id="rmonline_video_category_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12 mt-4">
                                        <label for="rmonline_video_content">Content</label>
                                        <textarea class="form-control summernote" name="rmonline_video_content" id="rmonline_video_content" cols="30" rows="10">{{ $video[0]->post_content }}</textarea>
                                        <p class="validate_errors" id="rmonline_video_content_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="rmonline_video_id" id="rmonline_video_id" value="{{ $video[0]->id }}">
                                        <button type="button" class="btn btn-secondary" id="update-rmonline-video">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('rm-online-upanyasam.video.partials.videojs')
