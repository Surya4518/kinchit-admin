    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Enpani Audio
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Create Enpani Audio</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_enpani_audio_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="enpani_audio_title">Title</label>
                                        <input type="text" class="form-control" name="enpani_audio_title" id="enpani_audio_title" placeholder="Enter Audio Name">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" multiple name="enpani_audio_category[]" id="enpani_audio_category">
                                            ...
                                            <option value="{{ $enpani_categories[$i]->ID }}">{{ $enpani_categories[$i]->post_title }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-enpani-audio">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
