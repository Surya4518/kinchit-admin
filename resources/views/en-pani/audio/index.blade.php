...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Enpani Audios
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="/create-enpani-audio">Create Audio<i
                                    class="fa fa-plus mx-2"></i></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="enpani-audio-table" class="table">
        ...
        @include('en-pani.audio.partials.play_audio_modal')
    </div>
