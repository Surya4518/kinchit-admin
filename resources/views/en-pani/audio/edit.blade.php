...
<head>
    ...
    <title> KINCHITKARAM :: Enpani Audios </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Enpani Audio</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit Enpani Audio
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Edit Enpani Audio</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_enpani_audio_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="enpani_audio_title">Title</label>
                                        <input type="text" class="form-control" name="enpani_audio_title" id="enpani_audio_title" value="{{ $audio[0]->post_title }}" placeholder="Enter Audio Name">
                                        <p class="validate_errors" id="enpani_audio_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="enpani_audio_category">Category</label>
                                        <select class="form-control" multiple name="enpani_audio_category[]" id="enpani_audio_category">
                                            <option value="">Select category</option>
                                            @for ($i = 0; $i < $enpani_categories->count(); $i++)
                                                @php
                                                    $selected = in_array($enpani_categories[$i]->ID, json_decode($audio[0]->audio_parent ?? '[]'));
                                                @endphp
                                                <option {{ $selected ? 'selected' : '' }} value="{{ $enpani_categories[$i]->ID }}">
                                                    {{ $enpani_categories[$i]->post_title }}
                                                </option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors"  id="enpani_audio_category_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="enpani_audio_file">Upload Audio</label>
                                        <input type="file" accept=".mp3, .wav, .ogg" class="form-control" name="enpani_audio_file" id="enpani_audio_file">
                                        <audio autoplay="true"controls><source type = "audio/mp3" src = "{{ asset($audio[0]->guid) }}"></audio>
                                        <p class="validate_errors" id="enpani_audio_file_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="enpani_audio_edit_id" id="enpani_audio_edit_id" value="{{ $audio[0]->ID }}">
                                        <button type="button" class="btn btn-secondary" id="update-enpani-audio">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('en-pani.audio.partials.audiojs')
