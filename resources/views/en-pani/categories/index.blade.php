...
<head>
    ...
    <title> KINCHITKARAM :: ENPANI </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Enpani</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Enpani category
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Enpani Categories</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary enpani_categorycreatemodal">Create Category<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="enpani_category-table" class="table">
        ...
        @include('en-pani.categories.partials.enpani_category_create_modal')
        @include('en-pani.categories.partials.enpani_category_edit_modal')
    </div>
    ...
    @include('en-pani.categories.partials.categoryjs')
