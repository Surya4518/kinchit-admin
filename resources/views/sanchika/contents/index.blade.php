...
<head>
    ...
    <title> KINCHITKARAM :: SANCHIKA </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Sanchika</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Sanchika PDFs
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary sanchik_contentcreatemodal">Add PDF<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="sanchik-table" class="table">
        ...
        @include('sanchika.contents.partials.content_create_modal')
        @include('sanchika.contents.partials.content_edit_modal')
    </div>
    ...
    @include('sanchika.contents.partials.sanchika_contetntjs')
