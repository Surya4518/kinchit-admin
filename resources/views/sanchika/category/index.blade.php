...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Sanchika category
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Sanchika Categories</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary sanchik_categorycreatemodal">Create Category<i
        ...
        @include('sanchika.category.partials.category_create_modal')
        @include('sanchika.category.partials.category_edit_modal')
    </div>
    ...
    @include('sanchika.category.partials.sanchikajs')
