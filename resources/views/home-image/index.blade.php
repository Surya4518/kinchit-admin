...
<head>
    ...
    <title> KINCHITKARAM :: Our Services </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Home Image</a></li>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary articlecreatemodal">Create Home Image<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="home-image-table" class="table">
        ...
        @include('home-image.partials.home_image_create_modal')
        @include('home-image.partials.home_image_edit_modal')
    </div>
    ...
    @include('home-image.partials.homeimagejs')
