<script>
    ...
    function showlist() {
        ...
        new DataTable('#services-table', {
            ...
            searching: true,
            ajax: {
                url: "{{ route('get-our-service.our-service') }}",
                method: 'POST',
                headers: {
    ...
    function CreateService() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('create-our-service.our-service') }}",
            data: formdata,
            headers: {
                'X-CSRF-TOKEN': csrfToken
            },
    ...
    function ServiceStatusChange(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('our-service-change-status.our-service') }}",
                    data: {
                        id: id,
    ...
    function EditServices(id) {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('get-our-service-data.our-service') }}",
            data: {
                id: id
            },
            headers: {
    ...
    function UpdateTheDataOfService() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('delete-data-our-service.our-service') }}",
            data: formdata,
            headers: {
                'X-CSRF-TOKEN': csrfToken
            },
