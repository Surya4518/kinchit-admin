...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Our Service</a></li>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary articlecreatemodal">Create Service<i
        ...
        @include('our-service.partials.service_article_create_modal')
        @include('our-service.partials.service_article_edit_modal')
    </div>
    ...
    @include('our-service.partials.servicesjs')
