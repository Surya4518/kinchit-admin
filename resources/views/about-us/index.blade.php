...
<head>
    ...
    <title> KINCHITKARAM :: About Us </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary articlecreatemodal">Create About Us<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="about-us-table" class="table">
        ...
        @include('about-us.partials.about_us_create_modal')
        @include('about-us.partials.about_us_edit_modal')
    </div>
    ...
    @include('about-us.partials.about-us-js')
