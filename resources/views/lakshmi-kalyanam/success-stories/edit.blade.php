            ...
            <div class="main-container container-fluid">
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                         <div class="row">
                            <form method="post" id="update_success_story_form" enctype="multipart/form-data">
                                <div class="row p-3">
                                <div class="col-md-6 mb-3">
                                    <label for="name" class="form-label">Brides Name</label>
                                    <input type="name" class="form-control" id="bride_name" name="bride_name" placeholder="Enter your bride name" value="{{ $success_story[0]->bridename }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="name" class="form-control" id="bride_id" name="bride_id" placeholder="Enter your bride id" value="{{ $success_story[0]->brideid }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="name" class="form-control" id="groom_name" name="groom_name" placeholder="Enter your groom name" value="{{ $success_story[0]->groomname }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="name" class="form-control" id="groom_id" name="groom_id" placeholder="Enter your groom id" value="{{ $success_story[0]->groomid }}">
                                  ...
                                  <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter your Email ID" value="{{ $success_story[0]->email }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="name" class="form-control" id="mobile_no" name="mobile_no" placeholder="Enter your Mobile Number" value="{{ $success_story[0]->mobile }}">
                                  ...
                                  <div class="col-md-12 mb-3">
                                   ...
                                   <textarea class="form-control summernote" id="contact_address" name="contact_address">{{ $success_story[0]->address }}</textarea>
                                ...
                                <div class="col-md-12 mb-3">
                                   ...
                                   <textarea class="form-control summernote" id="success_comments" name="success_comments">{{ $success_story[0]->successmessage }}</textarea>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="wedding_date" name="wedding_date" placeholder="Enter your Wedding date" value="{{ $success_story[0]->marriagedate }}">
                                 ...
                                 <div class="col-md-6 mb-3">
                                    ...
                                    @if ($success_story[0]->weddingphoto != NULL)
                                    <img src="{{ asset($success_story[0]->weddingphoto) }}" alt="" style="width: 19%;">
                                    <span><a href="javascript:DeleteTheImage({{ $success_story[0]->id }})" title="Edit Item" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary editservices"><i class="fe fe-x" style="font-size:16px;"></i></a></span>
                                    @endif
                                 ...
                                 <div class="col-12 text-center mg-t-40">
                                    <input type="hidden" name="id" id="id" value="{{ $success_story[0]->id }}">
                                    <button type="button" class="btn btn-secondary" id="update-success-story">Submit</button>
                                 </div>
