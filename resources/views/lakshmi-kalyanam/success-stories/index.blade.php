                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                         <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="/lakshmi-kalyanam/create-success-story">Create Story<i class="fa fa-plus mx-2"></i></a>
                        </div>
                            <div class="table-responsive">
                                <table id="success-story-table" class="table">
                                    <thead class="table-light">
                                        <tr>
                                        <th>#</th>
                                        <th>Bride's Name </th>
                                        <th>Bride's Profie ID</th>
                                        <th>Groom's Name</th>
                                         <th>Groom's Profie ID</th>
                                         <th>Email ID</th>
                                         <th>Mobile Number</th>
                                         <th>Conatct Address</th>
                                         <th>Your Comments on kinchit org</th>
                                         <th>Weeding Date</th>
                                         <th>Wedding Photo</th>
                                         <th>Status</th>
                                        <th>Action</th>
