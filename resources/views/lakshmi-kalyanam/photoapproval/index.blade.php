...
<head>
    ...
    <title> KINCHITKARAM :: Photo Approval </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Photo Approval
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Photo Approval List</h3>
                        <div class="row">
                            <div class="col-6">
                                <select class="form-control select2" name="photo_select" id="photo_select">
    ...
    <script></script>
    @include('lakshmi-kalyanam.photoapproval.partials.photoapprovaljs')
