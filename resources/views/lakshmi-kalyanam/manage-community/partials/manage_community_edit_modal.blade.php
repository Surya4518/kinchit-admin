<div class="modal fade" id="edit_community_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Community</h1>
        ...
        <form method="post" id="data_update_form" enctype="multipart/form-data">
            <div class="row p-3">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="edit_community_title" name="edit_community_title" placeholder="Enter your Community">
                    <p class="validate_errors" id="edit_community_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                </div>
                <div class="col-md-12 mb-3">
