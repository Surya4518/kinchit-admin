...
<head>
    ...
    <title> KINCHITKARAM ::Express Interest </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Express Interest</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Express Interest List
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Express Interest List</h3>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="express-interest-table" class="table">
    ...
    <script></script>
    @include('lakshmi-kalyanam.express-interest.partials.expressinterestjs')
