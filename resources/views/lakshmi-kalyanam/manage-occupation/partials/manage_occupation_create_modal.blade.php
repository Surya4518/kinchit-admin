<div class="modal fade" id="create_occupation_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Occupation</h1>
        ...
        <form method="post" id="data_create_form" enctype="multipart/form-data">
            <div class="row p-3">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="email" class="form-control" id="occupation_title" name="occupation_title" placeholder="Enter your Occupation">
                    <p class="validate_errors" id="occupation_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                </div>
                <div class="col-md-12 mb-3">
