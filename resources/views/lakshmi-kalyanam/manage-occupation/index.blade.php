...
<head>
    ...
    <title> KINCHITKARAM :: Manage Occupation </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Manage Occupation</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Occupation List
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Manage Occupation List</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_occupation_modal">Create occupation<i
         ...
         @include('lakshmi-kalyanam.manage-occupation.partials.manage_occupation_create_modal')
         @include('lakshmi-kalyanam.manage-occupation.partials.manage_occupation_edit_modal')
    </div>
    ...
    <script></script>
    @include('lakshmi-kalyanam.manage-occupation.partials.occupationjs')
