<script>
    ...
    function showlist() {
        ...
        var existingTable = $('#education-table').DataTable();
        if (existingTable) {
        ...
        new DataTable('#education-table', {
            ...
            searching: true,
            ajax: {
                url: "{{ route('get-manage-education.laksh_education') }}",
                method: 'POST',
                headers: {
    ...
    function Status_es_Change(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('change-education-status.laksh_education') }}",
                    data: {
                        id: id,
    ...
    function DeleteData(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('delete-education-data.laksh_education') }}",
                    data: {
                        id: id
                    },
                    headers: {
    ...
    function CreateData() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('create-the-education.laksh_education') }}",
            data: formdata,
            headers: {
                'X-CSRF-TOKEN': csrfToken
            },
            success: function(response) {
                if (response['status'] == 200) {
                    ...
                    $('#create_education_modal').modal('hide')
                    Swal.fire({
                        position: "top-right",
                        icon: "success",
                        title: 'Success..!',
    ...
    function EditData(id) {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('get-the-education.laksh_education') }}",
            data: {
                id: id
            },
            headers: {
            ...
            success: function(response) {
                ...
                if (response['status'] == 200) {
                    $('#edit_education_title').val(response['data'].name)
    ...
    function UpdateTheData() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('update-the-education.laksh_education') }}",
            data: formdata,
            headers: {
                'X-CSRF-TOKEN': csrfToken
            },
