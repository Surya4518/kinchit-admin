...
<head>
    ...
    <title> KINCHITKARAM :: Manage State </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show state List
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Manage State List</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_state_modal">Create State<i
         ...
         @include('lakshmi-kalyanam.manage-state.partials.manage_state_create_modal')
         @include('lakshmi-kalyanam.manage-state.partials.manage_state_edit_modal')
    </div>
    ...
    <script></script>
    @include('lakshmi-kalyanam.manage-state.partials.statejs')
