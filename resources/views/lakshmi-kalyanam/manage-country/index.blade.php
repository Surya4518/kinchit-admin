...
<head>
    ...
    <title> KINCHITKARAM :: Manage Country </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Manage Country</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Country List
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_country_modal">Create Country<i
         ...
         @include('lakshmi-kalyanam.manage-country.partials.manage_country_create_modal')
         @include('lakshmi-kalyanam.manage-country.partials.manage_country_edit_modal')
    </div>
    ...
    <script></script>
    @include('lakshmi-kalyanam.manage-country.partials.countryjs')
