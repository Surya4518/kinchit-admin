...
<head>
    ...
    <title> KINCHITKARAM :: Manage Subsection </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Manage Subsection</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show subsection List
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Manage Subsection List</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_subsection_modal">Create Subsection<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="subsection-table" class="table">
         ...
         @include('lakshmi-kalyanam.manage-subsection.partials.manage_subsection_create_modal')
         @include('lakshmi-kalyanam.manage-subsection.partials.manage_subsection_edit_modal')
    ...
    <script></script>
    @include('lakshmi-kalyanam.manage-subsection.partials.sebsectionjs')
