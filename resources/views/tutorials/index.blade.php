...
<head>
    ...
    <title> KINCHITKARAM :: Tutorials </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Tutorials category
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        @include('tutorials.partials.category_create_modal')
        @include('tutorials.partials.category_edit_modal')
    </div>
    ...
    @include('tutorials.partials.categoryjs')
