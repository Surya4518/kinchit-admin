...
<head>
    ...
    <title> KINCHITKARAM :: Tutorial Videos </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Tutorial Video</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit Tutorial Video
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Edit Tutorial Video</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="update_tutorial_video_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="tutorial_video_title">Title</label>
                                        <input type="text" class="form-control" name="tutorial_video_title" id="tutorial_video_title" value="{{ $video[0]->post_title }}" placeholder="Enter video Name">
                                        <p class="validate_errors" id="tutorial_video_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="tutorial_video_category">Category</label>
                                        <select class="form-control" name="tutorial_video_category" id="tutorial_video_category">
                                            <option value="">Select category</option>
                                            @for ($i=0; $i < $tutorial_categories->count(); $i++)
                                            <option {{ $video[0]->audio_category_id == $tutorial_categories[$i]->id ? 'selected' : '' }} value="{{ $tutorial_categories[$i]->id }}">{{ $tutorial_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors"  id="tutorial_video_category_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-12 mt-4">
                                        <label for="tutorial_video_content">Content</label>
                                        <textarea class="form-control summernote" name="tutorial_video_content" id="tutorial_video_content" cols="30" rows="10">{{ $video[0]->post_content }}</textarea>
                                        <p class="validate_errors" id="tutorial_video_content_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="tutorial_video_edit_id" id="tutorial_video_edit_id" value="{{ $video[0]->ID }}">
                                        <button type="button" class="btn btn-secondary" id="update-tutorial-video">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('tutorials.video.partials.videojs')
