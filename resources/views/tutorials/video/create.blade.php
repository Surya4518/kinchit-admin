    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Create Tutorial Video
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Create Tutorial Video</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_tutorial_video_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="tutorial_video_title">Title</label>
                                        <input type="text" class="form-control" name="tutorial_video_title" id="tutorial_video_title" placeholder="Enter video Name">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="tutorial_video_category" id="tutorial_video_category">
                                            ...
                                            <option value="{{ $tutorial_categories[$i]->id }}">{{ $tutorial_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <textarea class="form-control summernote" name="tutorial_video_content" id="tutorial_video_content" cols="30" rows="10"></textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <button type="button" class="btn btn-secondary" id="create-tutorial-video">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
