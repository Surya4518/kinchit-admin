...
<head>
    ...
    <title> KINCHITKARAM :: Tutorial Audios </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Tutorial Audio</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Edit Tutorial Audio
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Edit Tutorial Audio</h3>
                        <div class="card-body">
                           <div class="row">
                            <form method="post" id="create_tutorial_audio_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="tutorial_audio_title">Title</label>
                                        <input type="text" class="form-control" name="tutorial_audio_title" id="tutorial_audio_title" value="{{ $audio[0]->post_title }}" placeholder="Enter Audio Name">
                                        <p class="validate_errors" id="tutorial_audio_title_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="tutorial_audio_category">Category</label>
                                        <select class="form-control" name="tutorial_audio_category" id="tutorial_audio_category">
                                            <option value="">Select category</option>
                                            @for ($i=0; $i < $tutorial_categories->count(); $i++)
                                            <option {{ $audio[0]->audio_category_id == $tutorial_categories[$i]->id ? 'selected' : '' }} value="{{ $tutorial_categories[$i]->id }}">{{ $tutorial_categories[$i]->category_name }}</option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors"  id="tutorial_audio_category_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="col-6">
                                        <label for="tutorial_audio_file">Upload Audio</label>
                                        <input type="file" accept=".mp3, .wav, .ogg" class="form-control" name="tutorial_audio_file" id="tutorial_audio_file">
                                        <audio autoplay="true"controls><source type = "audio/mp3" src = "{{ asset($audio[0]->guid) }}"></audio>
                                        <p class="validate_errors" id="tutorial_audio_file_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-12 text-center mg-t-40">
                                        <input type="hidden" name="tutorial_audio_edit_id" id="tutorial_audio_edit_id" value="{{ $audio[0]->ID }}">
                                        <button type="button" class="btn btn-secondary" id="update-tutorial-audio">Submit</button>
                                    </div>
                                </div>
                            </form>
                           </div>
    ...
    <script></script>
    @include('tutorials.audio.partials.audiojs')
