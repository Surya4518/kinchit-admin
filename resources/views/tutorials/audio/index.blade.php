    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Tutorial Audios
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Tutorial Audios</h3>
                        <div class="button text-end mb-4">
                            <a class="btn btn-secondary" href="/create-tutorial-audio">Create Audio<i
        ...
        @include('tutorials.audio.partials.play_audio_modal')
    </div>
