...
<head>
    ...
    <title> KINCHITKARAM :: Services </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary articlecreatemodal">Create Article<i
        ...
        @include('services-articles.partials.service_article_create_modal')
        @include('services-articles.partials.service_article_edit_modal')
    </div>
    ...
    @include('services-articles.partials.servicesjs')
