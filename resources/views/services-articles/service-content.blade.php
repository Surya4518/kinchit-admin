    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               <li class="breadcrumb-item"><a href="javascript:void(0);">Services / {{ $alldatas['serviceTitle'] }}</a></li>
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h4>{{ $alldatas['serviceTitle'] }}</h4>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary servicecontentcreate">Add Contents<i
                                        class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="service-content-table" class="table">
        ...
        @include('services-articles.partials.service_content_create_modal')
        @include('services-articles.partials.service_content_edit_modal')
        @include('services-articles.partials.service_content_image_upload_modal')
    </div>
