...
<head>
    ...
    <title> KINCHITKARAM :: My Profile </title>
                       ...
                       <div class="col-md-6 mb-3">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item " aria-current="page"> Update Profile
                                </li>
                            </ol>
                        </nav>
                    </div>
...
<div class="card">
    <div class="row">
        <h3 id="page_title_name">My Profile</h3>
        <div class="card-body">
            <div class="volun-frm">
                <form method="post" enctype="multipart/form-data" id="user_profile_update">
                    <div class="row mb-2">
                        <div class="col-md-6 mb-3">
    ...
    @include('volunteer.partials.myprofilejs')
