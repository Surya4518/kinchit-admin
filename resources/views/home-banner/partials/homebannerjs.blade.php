<script>
    ...
    function showlist() {
        ...
        new DataTable('#home-image-table', {
            ...
            searching: true,
            ajax: {
                url: "{{ route('get-home-banner.home-banner') }}",
                method: 'POST',
                headers: {
    ...
    $.ajax({
        type: 'post',
        url: "{{ route('create-home-banner.home-banner') }}",
        data: formData,
        contentType: false,
        processData: false,
        headers: {
    ...
    function ServiceStatusChange(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('home-banner-change-status.home-banner') }}",
                    data: {
                        id: id,
    ...
    function EditServices(id) {
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('get-home-banner-data.home-banner') }}",
            data: {
                id: id
            },
            headers: {
            ...
            success: function(response) {
                ...
                if (response['status'] == 200) {
                    ...
                    $('#view_image').attr('src', response['data'][0].bannerimage);
    ...
    $.ajax({
        type: 'post',
        url: "{{ route('update-home-banner-data.home-banner') }}",
        data: formData,
        contentType: false,
        processData: false,
        headers: {
    ...
    function DeleteTheService(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('delete-data-home-banner.home-banner') }}",
                    data: {
                        id: id
                    },
                    headers: {
