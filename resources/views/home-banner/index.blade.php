...
<head>
    ...
    <title> KINCHITKARAM :: Banner Image </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary articlecreatemodal">Create Banner Image<i
        ...
        @include('home-banner.partials.home_banner_create_modal')
        @include('home-banner.partials.home_banner_edit_modal')
    </div>
    ...
    @include('home-banner.partials.homebannerjs')
