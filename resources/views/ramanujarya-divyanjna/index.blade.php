    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Ramanujarya Divyanjna</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Ramanujarya Divyanjna
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Ramanujarya Divyanjna</h3>
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <a type="button" href="/create-booking" class="btn btn-secondary">Create Booking<i class="fa fa-plus mx-2"></i></a>
                            </div>
                            <div class="table-responsive">
                                <table id="rdbooking-table" class="table">
