            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Booking Edit</a></li>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="volun-frm">
                                <form method="post" enctype="multipart/form-data" id="rdbook_update_form">
                                   <div class="row mb-2">
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Enter Your First Name</label>
                                           <input type="text" class="form-control" value="{{ $data[0]->booker_name }}" id="booker_name" name="booker_name">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $data[0]->booker_lastname }}" id="booker_lastname" name="booker_lastname">
                                       ...
                                       <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" name="no_of_ppl" id="no_of_ppl">
                                            ...
                                            @for ($i=1; $i <= 5; $i++)
                                                <option {{ $data[0]->no_of_people == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                            @endfor
                                        </select>
                                        <p class="validate_errors" id="no_of_ppl_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="row additional">
                                        @for ($i=0; $i < count($count = json_decode($data[0]->people_names)); $i++)
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="form-label">People No {{ $i+1 }}</label>
                                            <input type="text" class="form-control" name="ppl_names[]" id="ppl_names" value="{{$count[$i]}}" placeholder="Enter the no ${$i} people name">
                                            <p class="validate_errors" id="ppl_names{{ $i }}_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                        </div>
                                        @endfor
                                       </div>
                                         <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Divyadesam</label>
                                            <input type="email" class="form-control" value="{{ $data[0]->divyadesam }}" id="divyadesam" name="divyadesam">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">From Date</label>
                                            <input type="date" class="form-control" value="{{ $data[0]->date_from }}" id="date_from" name="date_from">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">To Date</label>
                                            <input type="date" class="form-control" value="{{ $data[0]->date_to }}" id="date_to" name="date_to">
                                        ...
                                        <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Phone No</label>
                                            <input type="text" class="form-control" value="{{ $data[0]->phone_no }}" id="phone_no" name="phone_no">
                                            <p class="validate_errors" id="phone_no_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Email</label>
                                           <input type="text" class="form-control" value="{{ $data[0]->email }}" id="email" name="email">
                                       ...
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="text" class="form-control" value="{{ $data[0]->address_1 }}" id="address1" name="address1">
                                        ...
                                        <div class="col-md-6 mb-3">
                                           ...
                                           <input type="text" class="form-control" value="{{ $data[0]->address_2 }}" id="address2" name="address2">
                                           <p class="validate_errors" id="address2_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="col-md-6 mb-3">
                                        <label for="name" class="form-label">City</label>
                                        <input type="text" class="form-control" value="{{ $data[0]->city }}" id="city_name" name="city_name">
                                        <p class="validate_errors" id="city_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">State</label>
                                           <input type="text" class="form-control" value="{{ $data[0]->state }}" id="state_name" name="state_name">
                                           <p class="validate_errors" id="state_name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="col-md-6 mb-3">
                                           <label for="name" class="form-label">Country</label>
                                           <input type="text" class="form-control" value="{{ $data[0]->country }}" id="country_name" name="country_name">
                                         ...
                                         <div class="col-md-6 mb-3">
                                           ...
                                           <input type="text" class="form-control" value="{{ $data[0]->pincode }}" id="pincode" name="pincode">
                                        ...
                                        <div class="col-md-6 mb-3">
                                           ...
                                           <select class="form-control" id="kkt_or_not" name="kkt_or_not">
                                            <option value="">Select</option>
                                            <option {{ $data[0]->kkt_or_not == 'yes' ? 'selected' : '' }} value="yes">Yes</option>
                                            <option {{ $data[0]->kkt_or_not == 'no' ? 'selected' : '' }} value="no">No</option>
                                           </select>
                                           <p class="validate_errors" id="kkt_or_not_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                       </div>
                                       <div class="row additional1">
                                        @if ($data[0]->kkt_or_not == 'yes')
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="form-label">Membership ID</label>
                                            <input type="text" class="form-control" name="membership_id" id="membership_id" value="{{ $data[0]->membership_id }}" placeholder="Enter Membership Id">
                                   ...
                                   <div class="row justify-content-center">
                                       <div class="col-md-12 text-center">
                                        <input type="hidden" name="book_edit_id" id="book_edit_id" value="{{ $data[0]->id }}">
                                          <button type="button" id="rdbook-update" onclick="updatethebookdata()" class="btn btn-secondary">Submit</button>
                                       </div>
                                   </div>
                                </form>
                            </div>
