...
<head>
    ...
    <title> KINCHITKARAM :: Gallery </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary gallerycreatemodal">Create<i
        ...
        @include('gallery-category.partials.gallery_create_modal')
        @include('gallery-category.partials.gallery_edit_modal')
    </div>
    ...
    @include('gallery-category.partials.gallery-categoryjs')
