...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
                    ...
                    <div class="col-sm-6 main-card card mx-auto">
                        ...
                        <div class="card-body">
                            <div class="row report-form">
                                <div class="col-12">
                                    <label for="user_for_report"><strong>User</strong></label>
                                    <select class="form-select select2" name="user_for_report" id="user_for_report">
    ...
    @include('reports.user-report.partials.reportsjs');
