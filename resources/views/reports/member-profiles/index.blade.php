...
<head>
    ...
    <title> KINCHITKARAM ::Member Profiles </title>
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Member Profiles</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Member Profiles List
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <table id="community-table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                           ...
                                           <td>
                                               <ul class="d-flex p-0">
                                                   <li style="list-style-type: none;"><a href="javascript:void(0);" title="Edit Item" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary editvolunteer" data-bs-toggle="modal" data-bs-target="#edit_community"><i class="fa fa-edit"></i></a></li>
                                                   <li style="list-style-type: none;margin-left: 10px;"><a href="#" target="_blank"  title="Show Members" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary editvolunteer" ><i class="fa fa-trash"></i></a></li>
