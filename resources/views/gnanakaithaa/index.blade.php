...
<head>
    ...
    <title> KINCHITKARAM :: Gnanakaitha Requests </title>
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    ...
                    <div class="input-group">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Gnanakaitha Requests</a></li>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Gnanakaitha Requests</h3>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="gnanakaitha-table" class="table">
        ...
        @include('gnanakaithaa.partials.request_reject_modal')
    </div>
