...
<head>
    ...
    <title> KINCHITKARAM :: Gnanakaitha Rejected Requests </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Gnanakaitha Rejected Requests</a></li>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Gnanakaitha Rejected Requests</h3>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="gnanakaitha-rejected-table" class="table">
    ...
    <script>
        ...
        var existingTable = $('#gnanakaitha-rejected-table').DataTable();
        if (existingTable) {
            existingTable.destroy();
        }
        new DataTable('#gnanakaitha-rejected-table', {
            processing: true,
            searching: true,
            ajax: {
                url: "{{ route('get-rejected-gnanakaitha-requests.gnanakaitha') }}",
                method: 'POST',
                headers: {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<ul style="display: flex;">
                         <li  style="list-style-type: none;"><a href="/gnanakaithaa/${row.id}" title="Approve It" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-secondary is_verified"><i class="fa fa-eye"></i></a></li>
