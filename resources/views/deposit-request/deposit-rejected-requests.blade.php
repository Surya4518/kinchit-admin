                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Rejectet Requests</a></li>
                                ...
                                <table id="approved-table" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i=0; $i < count($requests); $i++)
                                            <tr>
                                                <td>{{ $i+1 }}</td>
                                                <td>{{ $requests[$i]->first_name }}</td>
                                                <td>{{ $requests[$i]->phone_number }}</td>
