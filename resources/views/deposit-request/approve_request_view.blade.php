        ...
        <div class="card-body">
            <div class="volun-frm">
                <form method="" enctype="multipart/form-data" id="user_profile_update">
                    <div class="row mb-2">
                        <div class="col-md-6 mb-3">
                            <label for="user_first_name" class="form-label"> First Name: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" id="user_first_name" value="{{$user[0]->first_name}}" name="user_first_name" aria-describedby="emailHelp" pattern="[A-Za-z. ]+" title="Please enter only alphabetical characters, spaces, and periods (dots)">
                            <p class="validate_errors" id="user_first_name_error" style="color: #f90404; font-size: 13px; font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_first_name" class="form-label"> Last Name: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" id="user_first_name" value="{{$user[0]->last_name}}" name="user_first_name" aria-describedby="emailHelp" pattern="[A-Za-z. ]+" title="Please enter only alphabetical characters, spaces, and periods (dots)">
                            <p class="validate_errors" id="user_first_name_error" style="color: #f90404; font-size: 13px; font-family: 'circular';"></p>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="user_sms_no" class="form-label">Deposit To: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" value="{{$user[0]->deposit_to}}" id="user_sms_no" name="user_sms_no" aria-describedby="emailHelp" pattern="[0-9]{1,10}" maxlength="10" title="Please enter only numeric characters with maximum length of 10">
                            <p class="validate_errors" id="user_sms_no_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_sms_no" class="form-label">Donation Year: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" value="{{$user[0]->donation_year}}" id="user_sms_no" name="user_sms_no" aria-describedby="emailHelp" pattern="[0-9]{1,10}" maxlength="10" title="Please enter only numeric characters with maximum length of 10">
                            <p class="validate_errors" id="user_sms_no_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_sms_no" class="form-label">TTL Amount Deposit: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" value="{{$user[0]->ttl_amt_deposited}}" id="user_sms_no" name="user_sms_no" aria-describedby="emailHelp" pattern="[0-9]{1,10}" maxlength="10" title="Please enter only numeric characters with maximum length of 10">
                            <p class="validate_errors" id="user_sms_no_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="user_sms_no" class="form-label">Payment Date: <span style="color:#f90404">*</span></label>
                            <input type="text" class="form-control" value="{{$user[0]->payment_date}}" id="user_sms_no" name="user_sms_no" aria-describedby="emailHelp" pattern="[0-9]{1,10}" maxlength="10" title="Please enter only numeric characters with maximum length of 10">
                            <p class="validate_errors" id="user_sms_no_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                        </div>
                    </div>
                </form>
