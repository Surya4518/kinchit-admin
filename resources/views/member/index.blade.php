...
<head>
    ...
    <title> KINCHITKARAM :: Members </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
            ...
            <div class="main-container container-fluid">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Show Members
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <h3>Members</h3>
                        <div class="row">
                            <form method="POST" id="members_filter_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-2 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2 mt-2">
                                            ...
                                            <select class="form-control" name="member_status_filter" id="member_status_filter">
                                    ...
                                    <div class ="row justify-content-center">
                                        <div class="col-md-3">
                                            <button type="button" onclick="showmemberlist()" class="btn btn-secondary">Search Members<span id="members_filter"></span></button>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <a type="button" href="/create-user-profile" class="btn btn-secondary tut_categorycreatemodal">Add User<i class="fa fa-plus mx-2"></i></a>
                            </div>
                            <div class="table-responsive">
                                <table id="mem-table" class="table">
        ...
        @include('volunteer.partials.send_request_modal')
    </div>
    ...
    @include('member.partials.memberjs')
