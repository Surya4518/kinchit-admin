<div id="donation_edit_modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width: 75%;">
      <div class="modal-content">
        ...
        <div class="modal-body mx-3">
            <form method="post" id="edit_donation_form">
            <div class="row">
                    <div class="col-12 md-form mb-5">
                    <label for="">Category Name : </label>
                    <input type="hidden" class="form-control" name="edit_donation_id" id="edit_donation_id">
        ...
        <div class="modal-footer mx-auto">
            <button class="btn btn-secondary" onclick="UpdateTheDataOfDonation()">Submit</button>
        </div>
      </div>
    </div> <!-- modal-bialog .// -->
  </div> <!-- modal.// -->
