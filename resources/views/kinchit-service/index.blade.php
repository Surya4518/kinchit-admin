...
<head>
    ...
    <title> KINCHITKARAM :: Kinchit Services </title>
...
<body class="main-body app sidebar-mini ltr" oncontextmenu="return false;">
    ...
    <div class="page custom-index">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Kinchit Services</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Show Services
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="button text-end mb-4">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#create_services_modal">Create Services<i
                                    class="fa fa-plus mx-2"></i></button>
                            </div>
                            <div class="table-responsive">
                                <table id="kinchit-service-table" class="table">
        ...
        @include('kinchit-service.partials.service_create_modal')
        @include('kinchit-service.partials.edit_service_modal')
    </div>
    ...
    @include('kinchit-service.partials.kinchit_servicejs')
