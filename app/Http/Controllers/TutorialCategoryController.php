...
class TutorialCategoryController extends Controller
{
    ...
    public function UpdateTheSortOrderOfTutorialCategory(Request $request)
    {
        ...
        $update = Tutorial_categories::where('id', $request->id)->update($arr);
        $data = Tutorial_categories::where('id', $request->id)->first();
