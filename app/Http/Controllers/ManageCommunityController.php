...
class ManageCommunityController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lakshmi-kalyanam.manage-community.index', compact('alldatas'));
    }

    public function ShowList(Request $request)
    {
        $result = MangeCommunity::whereNull('deleted_at')
            ->orderBy('id', 'ASC')
            ->get();
    ...
    {
        $model = MangeCommunity::find($request->id);
        $update = $model->update([
    ...
    {
        $delete = MangeCommunity::find($request->id)->delete();
    ...
    public function CreateData(Request $request)
    {
        ...
        $create = MangeCommunity::create([
            'name' => $request->community_title,
    ...
    {
        $result = MangeCommunity::find($request->id);
    ...
    public function UpdateData(Request $request)
    {
        ...
        $update = MangeCommunity::find($request->edit_id)->update([
            'name' => $request->edit_community_title,
            'sortorder' => $request->edit_sort_order,
            'status' => $request->edit_status_of_data,
        ]);
        $data = MangeCommunity::find($request->edit_id)->update([
            'name' => $request->edit_community_title,
            'sortorder' => $request->edit_sort_order,
            'status' => $request->edit_status_of_data,
        ]);
