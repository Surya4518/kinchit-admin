...
class ServicesController extends Controller
{
    ...
    public function UpdateTheDataOfService(Request $request)
    {
        ...
        return response()->json($ins == true ? ['status' => 200, 'message' => 'Service successfully updated'] : ['status' => 400, 'message' => 'Failed to update service']);
    }
    ...
    public function UpdateTheDataOfServiceContent(Request $request)
    {
        ...
        return response()->json($service_content_update == true ? ['status' => 200, 'message' => 'Service Content successfully updated'] : ['status' => 400, 'message' => 'Failed to update service']);
    }
