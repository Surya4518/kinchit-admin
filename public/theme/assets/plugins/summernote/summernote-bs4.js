				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							...
							n = '<input type="button" href="#" class="'.concat("btn btn-secondary note-btn note-btn-primary note-link-btn", '" value="').concat(this.lang.link.insert, '" disabled>');
				...
				return e = t, (n = [{
					...
					value: function() {
						...
						var o = this.options.dialogsInBody ? this.$body : this.options.container,
							...
							r = '<input type="button" href="#" class="'.concat("btn btn-secondary note-btn note-btn-primary note-image-btn", '" value="').concat(this.lang.image.insert, '" disabled>');
						this.$dialog = this.ui.dialog({
				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							...
							n = '<input type="button" href="#" class="'.concat("btn btn-secondary note-btn note-btn-primary note-video-btn", '" value="').concat(this.lang.video.insert, '" disabled>');
						this.$dialog = this.ui.dialog({
